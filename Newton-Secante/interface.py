...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        command = lambda : self.buttonClick("-", "-"), font = ("Calibri", 20, "bold"))
        self.Subbutton.grid(row = 4, column = 3, sticky = N+W+E+S)
        ...
        self.Sqrtbutton.grid(row = 6, column = 4, sticky = N+W+E+S)
        ...
        command = lambda : self.buttonClick("**", "^"), font = ("Calibri", 20, "bold"))
        self.Elebutton.grid(row = 2, column = 4, sticky = N+W+E+S)
        ...
        self.Equalbutton.grid(row = 6, column = 1, sticky = N+W+E+S, columnspan = 2)
